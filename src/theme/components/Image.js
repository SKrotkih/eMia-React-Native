...
export default class ImageViewer extends Component {
  ...
  render() {
    ...
    const width =
      this._imageSize.width * (AppSizes.screen.width / this._imageSize.width);
    const height =
      this._imageSize.height * ((AppSizes.screen.height * 0.6) / this._imageSize.height);
      ...
      <View>
        ...
        <Modal
          ...
          <Animated.View
            ...
            <Animated.View
              style={[AppStyles.overlayHeader, {opacity: interpolatedOpacity}]}>
