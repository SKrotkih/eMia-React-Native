...
export default class ImageViewer extends Component {
    ...
    render() {
        ...
        if (this._imageSize.width / windowWidth > this._imageSize.height / windowHeight) {
            this._zoomedImageSize.width = windowWidth;
            this._zoomedImageSize.height = windowWidth / this._imageSize.width * this._imageSize.height;
        } else {
            this._zoomedImageSize.height = windowHeight;
            this._zoomedImageSize.width = windowHeight / this._imageSize.width * this._imageSize.height;
        }
        ...
        const height = this._imageSize.height * (windowHeight * 0.60 / this._imageSize.height);
                    ...
                    >
                        <Animated.View style={[styles.overlayHeader, {opacity: interpolatedOpacity}]}>
                            <View style={{flex: 1, alignItems: 'flex-start'}}>
                                ...
                                >
                                    <Icon style={{color: "#fff", backgroundColor: 'transparent'}} name={'ios-arrow-back'} />
                                </TouchableOpacity>
                            </View>
                            {downloadable &&
