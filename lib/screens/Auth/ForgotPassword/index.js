...
resetPassword=_index.actions.resetPassword;
...
ForgotPassword=function(_React$Component){_inherits(ForgotPassword,_React$Component);
function ForgotPassword(){_classCallCheck(this,ForgotPassword);var _this=_possibleConstructorReturn(this,(ForgotPassword.__proto__||Object.getPrototypeOf(ForgotPassword)).call(this));
...
}_createClass(ForgotPassword,[{key:'onSubmit',value:function onSubmit(
...
}}]);return ForgotPassword;}(_react2.default.Component);exports.default=


(0,_reactRedux.connect)(null,{resetPassword:resetPassword})(ForgotPassword);