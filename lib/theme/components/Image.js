...
var ret=_reactNativeFetchBlob2.default.config({
fileCache:true,
path:_reactNativeFetchBlob2.default.fs.dirs.DocumentDir+'/'+_uuid2.default.v4()+'.jpg'}).
fetch('GET',uri);
...
var value=(0,_util.backgroundValueCalculation)(this._layoutY,this._layoutX,BACKGROUND_VALUES);
...
if(this._imageSize.width/_theme.AppSizes.screen.width>this._imageSize.height/_theme.AppSizes.screen.height){
this._zoomedImageSize.width=_theme.AppSizes.screen.width;
this._zoomedImageSize.height=_theme.AppSizes.screen.width/this._imageSize.width*this._imageSize.height;
}else{
this._zoomedImageSize.height=_theme.AppSizes.screen.height;
this._zoomedImageSize.width=_theme.AppSizes.screen.height/this._imageSize.width*this._imageSize.height;
}
...
var width=this._imageSize.width*(_theme.AppSizes.screen.width/this._imageSize.width);
var height=this._imageSize.height*(_theme.AppSizes.screen.height*0.60/this._imageSize.height);
...
_react2.default.createElement(_reactNative.Animated.View,{style:[_theme.AppStyles.overlayHeader,{opacity:interpolatedOpacity}]},
...
_react2.default.createElement(_ui.Icon,{name:'arrow-back',size:22,color:'#FFF'}))),


downloadable&&
_react2.default.createElement(_reactNative.View,{style:{flex:1,alignItems:'flex-end'}},
_react2.default.createElement(_reactNative.TouchableOpacity,{
...
_react2.default.createElement(_ui.Icon,{name:'download',type:'foundation',size:22,color:'#FFF'})))),
